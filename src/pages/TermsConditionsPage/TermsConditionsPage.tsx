    ...
    <section className="section terms-and-conditions-section">
      <div className="section-content">
        ...
        <p>
          ...
          Cancellation infers that no services are rendered and a refund will be
          issued. Refunds can take 5-7 business days to show up in your account.
        </p>
        <p>
        ...
        <p>
          c) Clients who do not show up for their appointment will not receive a
          refund. Note: Clients who are more than 15 minutes late for their
        ...
        <p>
          ...
          National Council of Geocosmic Research, I adhere to all of the NCGR’s
          “Codes of EthicS” which you can read in full here. furthermore, please
          take the following into account when booking with me:
        </p>
